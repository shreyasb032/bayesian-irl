...
def run_one_simulation(args: argparse.Namespace, seed: int):
    ...
    directory = "./figures/Bounded-Rationality/fixed-trust-params/adaptive-learner/kappa" + str(kappa) + "/" + str(wh_hum) # Storage directory for the plots
...
def main(args: argparse.Namespace):
    ...
    data_direc = "./data/Bounded Rationality/fixed-trust-params/adaptive-learner/kappa" + str(kappa) + "/wh" + str(wh_hum) # Storage directory for the plots
    #################################################################################################################################
